...
func main() {
	...
	isVaildName, isVaildEmail, isVaildTicketNumber := ValidateUserInput(firstName, lastName, email, userTickets, remainingTickets)

	if isVaildName && isVaildEmail && isVaildTicketNumber {
